...
export default function HomeScreen() {
  ...
  return (
    <ScrollView
      ...
      contentContainerClassName="p-2 gap-y-8"
    >
      <Text className="font-montserrat text-2xl">Hi Mohamed 👋</Text>
      ...
      <View className="gap-y-4">
        ...
        <View className="items-center justify-center p-2 bg-linear-to-br bg-emerald-500 via-green-500 to-teal-500 rounded-2xl h-24">
          <Text className="text-white font-montserrat-medium text-2xl">
      ...
      <View>
        <Text className="text-xl font-montserrat-medium my-4">
